...
def main(opts):
    ...
    cfg['no_rmse'] = opts.no_rmse
    if opts.test_file is not None:
        cfg['test_file'] = opts.test_file
    ...
    print(cfg)
    # 执行
    trainer = Trainer(cfg, do_test=True)
    trainer.predict()
