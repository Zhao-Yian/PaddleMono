...
The training code of MLDANet has not been aligned yet. The [paddle weights]() of MLDANet provided by PaddleMono are converted from the corresponding torch weights, and this part will be released later.
